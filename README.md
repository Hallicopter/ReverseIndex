# TapSearch
Link to app: https://desolate-plateau-60006.herokuapp.com/
## Brief Description
Here is a very simple implementation of an inverted index with a very basic front end to use the same. 
The error handling is very minimal due to the time constraint at hand.
## Usage
1. Paste text into the text area and hit submit.
2. Index the text by hitting the Index button.
3. Search by typing the term in the search textbox and hitting search. Keep searching for words till your hearts' content.
...
## Output
The top 10 paragraphs based on the search term's occurance.

# Vision
Firstly, would have made the UX and UI much much better.
Apart from that, would have made the program with concurrency in mind.
Added the bonus tasks, which were not done due to the time crunch. 
